...
class SelectForm extends Component {
    ...
    static formOptions = [
        "apple", "cherry", "grape", "orange", "pear", "peach"
    ]
        ...
        <div className="container">
            <form>
                <div>
                    ...
                    <input  onChange={this.handleCommaSeparateChange}  type="text" className="form-control" />
                </div>
                ...
                <div>
                    <select multiple size={SelectForm.formOptions.length}
